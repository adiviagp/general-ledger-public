...
const JurnalUmumPendapatanPage = () => {
      ...
      accessorFn: (row) => (
        <>
          <div className="relative flex items-center px-4 gap-4">
            <Link to={`/jurnal/jurnal-umum/pendapatan/${row.id}/edit`}>
  ...
  return (
    <>
      <div className="flex justify-between items-center">
        <h1> Jurnal Umum - Khusus Pendapatan</h1>

        <Link to="/jurnal/jurnal-umum/pendapatan/add">
...
export default JurnalUmumPendapatanPage;
