    ...
    },
    {
      ...
      accessorFn: (row) => (
        <div className="relative flex items-center px-4 gap-4">
          <Link to={`/jurnal/jurnal-umum/modal/${row.id}/edit`}>
  ...
  return (
    <>
      <div className="flex justify-between items-center">
        <h1> Jurnal Umum - Khusus Modal</h1>
        <Link to="/jurnal/jurnal-umum/modal/add">
...
export default JurnalUmumModalPage;
