...
import { useGetNeracaSaldoDeposito } from '@src/hooks/neracaSaldo/useGetNeracaSaldoDeposito';

const NeracaSaldoDepositoPage = () => {
  const { startDate, endDate } = useUangMuka();

  const [columns, setColumns] = useState<any>([]);

  const { data, isLoading } = useGetNeracaSaldoDeposito({ startDate, endDate });
...
export default NeracaSaldoDepositoPage;
