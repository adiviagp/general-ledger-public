...
const LabaRugiPage = () => {
  ...
  const { data, isLoading } = useGetLabaRugi(params);
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  onClick={() => {
                    ...
                    window.open(`${BACKEND_URL}/laba-rugi/download-excel?startDate=${startDate}&endDate=${endDate}`, '_blank');
                  }}
                >
                  Download Excel
                </Button>
      ...
      {isSearched && data ? (
        <div className="rounded shadow-lg p-2 bg-white">
          <div className="flex justify-between p-2">
            <h2>Laba Rugi: {dateFinal && moment(dateFinal).format('YYYY-MM-DD')}</h2>
            <div></div>
          </div>
