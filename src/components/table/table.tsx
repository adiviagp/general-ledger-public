...
const Table = ({ data, columns, defaultWidth }: any) => {
  ...
  const [width, setWidth] = useState(window.innerWidth - 350);
    ...
    <div className="p-2" id="table-custom">
      <div className="overflow-x-auto">
        <table
          {...{
            style: {
              width: table.getCenterTotalSize() > 1200 ? table.getCenterTotalSize() : width,
            },
          }}
        >
          <thead>
